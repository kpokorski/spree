    ...
    module V2
      module Platform
        class ProductsController < ResourceController
          ...
          def translate
            return render_error_payload('No automated translations provider configured') unless automated_translations_service.enabled?
            ...
            if result.success?
              render_serialized_payload { { message: 'Requested translations were generated successfully' } }
            else
